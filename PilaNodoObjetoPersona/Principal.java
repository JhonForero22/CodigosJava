        ...
        do {
            ...
            switch (opcionMenu) {
                case 1:
                    ...
                    if(pilaNueva.verificarPersona(cedula) == true){
                        System.out.println("La " + cedula + ", ya se encuentra registrado!!!");
                    }else{
                        //Se agrega el dato a la Pila
                        pilaNueva.push( new Persona(cedula, nombre, correo));
                        System.out.println("El usuario " + nombre + ", se registro correctamente!!!");
                    }
